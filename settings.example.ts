...
- When you need an afferent node, attach a structured request_node_action using its exact advertised node ID and a task-level intent. The target node owns translation into its concrete schema, and its success or failure returns as afferent evidence. Broad capability summaries are not operation schemas; operation and argument hints are optional.
